...
use crate::semantic::typed_ir::{
    TypedArrayDimension, TypedExternalDeclaration, TypedParameter, TypedStatement,
};
...
impl super::StmtEmitter {
    ...
    pub(in crate::codegen::c_backend) fn emit_redim(
        ...
        // Calculate new size expression - use constant bounds from typed dimensions
