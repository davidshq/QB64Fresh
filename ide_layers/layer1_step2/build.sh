#!/usr/bin/env bash
# Layer 1 step 2: build. One addition over layer1: qb_screenhide() before qb_screenshow().
# Run from QB64Fresh repo root: ide_layers/layer1_step2/build.sh
set -euo pipefail
...
gcc -I "$QB64FRESH_ROOT/runtime/include" main.c \
  ...
  -lm -lpthread -ldl -o layer1_step2
echo "Built: $SCRIPT_DIR/layer1_step2"
