#!/usr/bin/env bash
# Layer 1: build minimal window with qb_gfx_screen first.
# Run from QB64Fresh repo root: ide_layers/layer1/build.sh
set -euo pipefail
...
gcc -I "$QB64FRESH_ROOT/runtime/include" main.c \
  ...
  -lm -lpthread -ldl -o layer1
echo "Built: $SCRIPT_DIR/layer1"
