#!/usr/bin/env bash
# Layer 1 step 8: build. Step7 + another ~25% IDE-like calls (50% total).
# Run from QB64Fresh repo root: ide_layers/layer1_step8/build.sh
set -euo pipefail
...
gcc -I "$QB64FRESH_ROOT/runtime/include" main.c \
  ...
  -lm -lpthread -ldl -o layer1_step8
echo "Built: $SCRIPT_DIR/layer1_step8"
