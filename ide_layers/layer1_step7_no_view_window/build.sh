#!/usr/bin/env bash
# Layer 1 step 7 no view/window: build (step7 with view_reset/window_reset commented out).
set -euo pipefail
...
gcc -I "$QB64FRESH_ROOT/runtime/include" main.c \
  ...
  -lm -lpthread -ldl -o layer1_step7_no_view_window
echo "Built: $SCRIPT_DIR/layer1_step7_no_view_window"
