/*
 * Layer 1 step 7 NO A: Step6 + Batch B + Batch C. Batch A commented out.
 * Use to confirm Batch A is the culprit for blank/no shapes.
 */
...
int main(void) {
    ...
    {
        QbString* title = qb_string_new("Layer1 step 7 (no A)");
        qb_sub__title(title);
