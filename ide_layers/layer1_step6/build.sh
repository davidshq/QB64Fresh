#!/usr/bin/env bash
# Layer 1 step 6: build. Batch over step5: title, color, print one line.
# Run from QB64Fresh repo root: ide_layers/layer1_step6/build.sh
set -euo pipefail
...
gcc -I "$QB64FRESH_ROOT/runtime/include" main.c \
  ...
  -lm -lpthread -ldl -o layer1_step6
echo "Built: $SCRIPT_DIR/layer1_step6"
