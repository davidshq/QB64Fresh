#!/usr/bin/env bash
# Layer 1 step 7: build. Step6 + ~25% IDE-like calls (big batch).
# Run from QB64Fresh repo root: ide_layers/layer1_step7/build.sh
set -euo pipefail
...
gcc -I "$QB64FRESH_ROOT/runtime/include" main.c \
  ...
  -lm -lpthread -ldl -o layer1_step7
echo "Built: $SCRIPT_DIR/layer1_step7"
