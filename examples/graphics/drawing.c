...
int main(int argc, char** argv) {
    ...
    qb_gfx_color((int32_t)15LL, (int32_t)1LL);
    qb_gfx_cls();
    qb_gfx_locate((int32_t)1LL, (int32_t)25LL);
    qb_print_string(qb_string_new("Graphics Drawing Demo"));
    qb_print_newline();
    int32_t _qb_for_end_val_1 = 100LL;
    int32_t _qb_for_step_2 = 1;
    for (int32_t x = 50LL; (_qb_for_step_2 > 0) ? (x <= _qb_for_end_val_1) : (x >= _qb_for_end_val_1); x += _qb_for_step_2) {
        int32_t _qb_for_end_val_4 = 100LL;
        int32_t _qb_for_step_5 = 1;
        for (int32_t y = 50LL; (_qb_for_step_5 > 0) ? (y <= _qb_for_end_val_4) : (y >= _qb_for_end_val_4); y += _qb_for_step_5) {
            if (((((x + y)) % 2LL) == 0LL)) {
                qb_gfx_pset_step((int32_t)x, (int32_t)y, (uint32_t)14LL, 0);
            }
        }
        _qb_for_end_3:;
    }
    _qb_for_end_0:;
    qb_gfx_line_ex((int32_t)150LL, (int32_t)50LL, (int32_t)300LL, (int32_t)50LL, 0, (uint32_t)15LL);
    qb_gfx_line_ex((int32_t)150LL, (int32_t)60LL, (int32_t)150LL, (int32_t)120LL, 0, (uint32_t)15LL);
    qb_gfx_line_ex((int32_t)160LL, (int32_t)60LL, (int32_t)300LL, (int32_t)120LL, 0, (uint32_t)10LL);
    qb_gfx_box_ex((int32_t)320LL, (int32_t)50LL, (int32_t)450LL, (int32_t)120LL, 0, (uint32_t)12LL, 0);
    qb_gfx_box_ex((int32_t)470LL, (int32_t)50LL, (int32_t)580LL, (int32_t)120LL, 0, (uint32_t)9LL, 1);
    qb_gfx_circle_step((int32_t)100LL, (int32_t)200LL, (int32_t)40LL, (uint32_t)14LL, 0, 0);
    qb_gfx_circle_step((int32_t)220LL, (int32_t)200LL, (int32_t)50LL, (uint32_t)13LL, 0, 0);
    qb_gfx_circle_step((int32_t)350LL, (int32_t)200LL, (int32_t)40LL, (uint32_t)11LL, 0, 0);
    qb_gfx_circle_step((int32_t)500LL, (int32_t)200LL, (int32_t)45LL, (uint32_t)12LL, 0, 0);
    qb_gfx_paint_step((int32_t)500LL, (int32_t)200LL, (uint32_t)4LL, (uint32_t)12LL, 0);
    qb_gfx_box_ex((int32_t)50LL, (int32_t)300LL, (int32_t)200LL, (int32_t)400LL, 0, (uint32_t)6LL, 1);
    qb_gfx_line_ex((int32_t)50LL, (int32_t)300LL, (int32_t)125LL, (int32_t)250LL, 0, (uint32_t)8LL);
    qb_gfx_line_ex((int32_t)125LL, (int32_t)250LL, (int32_t)200LL, (int32_t)300LL, 0, (uint32_t)8LL);
    qb_gfx_box_ex((int32_t)100LL, (int32_t)350LL, (int32_t)150LL, (int32_t)400LL, 0, (uint32_t)0LL, 1);
    qb_gfx_box_ex((int32_t)160LL, (int32_t)320LL, (int32_t)190LL, (int32_t)350LL, 0, (uint32_t)11LL, 0);
    qb_gfx_line_ex((int32_t)175LL, (int32_t)320LL, (int32_t)175LL, (int32_t)350LL, 0, (uint32_t)11LL);
    qb_gfx_line_ex((int32_t)160LL, (int32_t)335LL, (int32_t)190LL, (int32_t)335LL, 0, (uint32_t)11LL);
    int32_t _qb_for_end_val_7 = 50LL;
    int32_t _qb_for_step_8 = 10LL;
    for (int32_t r = 10LL; (_qb_for_step_8 > 0) ? (r <= _qb_for_end_val_7) : (r >= _qb_for_end_val_7); r += _qb_for_step_8) {
        qb_gfx_circle_step((int32_t)400LL, (int32_t)350LL, (int32_t)r, (uint32_t)((r / 10LL) + 9LL), 0, 0);
    }
    _qb_for_end_6:;
    float angle = 0.0;
    float radius = 0.0;
    ...
    cx = (int16_t)(550LL);
    cy = (int16_t)(350LL);
    int32_t _qb_for_end_val_10 = 200LL;
    int32_t _qb_for_step_11 = 1;
    for (int32_t i = 0LL; (_qb_for_step_11 > 0) ? (i <= _qb_for_end_val_10) : (i >= _qb_for_end_val_10); i += _qb_for_step_11) {
        angle = (float)((i * 0.14999999999999999));
        radius = (float)((i * 0.25000000000000000));
        x = (int32_t)((cx + (cos(angle) * radius)));
        y = (int32_t)((cy + (sin(angle) * radius)));
        qb_gfx_pset_step((int32_t)x, (int32_t)y, (uint32_t)(10LL + ((i % 6LL))), 0);
    }
    _qb_for_end_9:;
    qb_gfx_locate((int32_t)29LL, (int32_t)20LL);
