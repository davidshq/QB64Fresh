...
int main(int argc, char** argv) {
    ...
    qb_print_newline();
    qb_print_newline();
    qb_string* userName = qb_string_new("");
    qb_input_string("What is your name? ", &userName);
    qb_print_string(qb_string_new("Hello, "));
    qb_print_string(userName);
    qb_print_string(qb_string_new("!"));
    qb_print_newline();
    qb_print_newline();
    qb_print_string(qb_string_new("Welcome to QB64Fresh!"));
    qb_print_newline();
    qb_print_string(qb_string_new("====================="));
    qb_print_newline();
    qb_print_newline();
